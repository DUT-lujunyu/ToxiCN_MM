...
The dataset labels and captions generated by GPT-4V have been saved as train_data_discription.json.csv and test_data_discription.json in the ./data/ directory.


## Multimodal Knowledge Enhancement Detector
You need to place the extracted memes in the ./data/meme/ directory. 
